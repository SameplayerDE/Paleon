...
namespace Paleon
{
    public class MyTexture
    {
        ...
        public MyTexture(MyTexture parent, Rectangle clipRect)
            : this(parent, clipRect.X, clipRect.Y, clipRect.Width, clipRect.Height)
        {

        }

        public MyTexture(MyTexture parent, string atlasPath, Rectangle clipRect, Vector2 drawOffset, int width, int height)
        {
            Texture = parent.Texture;
            AtlasPath = atlasPath;
        ...
        public MyTexture(MyTexture parent, string atlasPath, Rectangle clipRect)
            : this(parent, clipRect)
        {
            AtlasPath = atlasPath;
        }

        public MyTexture(Texture2D texture, Vector2 drawOffset, int frameWidth, int frameHeight)
        {
            Texture = texture;
            ClipRect = new Rectangle(0, 0, texture.Width, texture.Height);
            DrawOffset = drawOffset;
        ...
        private void SetUtil()
        {
            ...
            UV = new Vector4(LeftUV, TopUV, RightUV, BottomUV);
        }
        ...
        public MyTexture GetSubtexture(int x, int y, int width, int height, MyTexture applyTo = null)
        {
            if (applyTo == null)
        ...
        public MyTexture GetSubtexture(Rectangle rect)
        {
            return new MyTexture(this, rect);
        }
        ...
        public override string ToString()
        {
            if (AtlasPath != null)
                ...
                return "MyTexture [" + Texture.Width + " x " + Texture.Height + "]";
        }
...
#endif
            RenderManager.SpriteBatch.Draw(Texture, dest, ClipRect, color, 0, -DrawOffset, SpriteEffects.None, 0);
        }

        public void Draw(Rectangle dest, Color color, float depth)
        {
#if DEBUG
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            RenderManager.SpriteBatch.Draw(Texture, dest, ClipRect, color, 0, -DrawOffset, SpriteEffects.None, depth);
        }
        ...
        public void Draw(Rectangle dest, Vector2 origin, Color color, float rotation, SpriteEffects effects)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            RenderManager.SpriteBatch.Draw(Texture, dest, ClipRect, color, rotation, origin - DrawOffset, effects, 0);
        }
        ...
        public void Draw(Vector2 position)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            RenderManager.SpriteBatch.Draw(Texture, position, ClipRect, Color.White, 0, -DrawOffset, 1f, SpriteEffects.None, 0);
        }
        ...
        public void Draw(Vector2 position, Vector2 origin)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            RenderManager.SpriteBatch.Draw(Texture, position, ClipRect, Color.White, 0, origin - DrawOffset, 1f, SpriteEffects.None, 0);
        }
        ...
        public void Draw(Vector2 position, Vector2 origin, Color color)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            RenderManager.SpriteBatch.Draw(Texture, position, ClipRect, color, 0, origin - DrawOffset, 1f, SpriteEffects.None, 0);
        }
        ...
        public void Draw(Vector2 position, Vector2 origin, Color color, float scale)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            RenderManager.SpriteBatch.Draw(Texture, position, ClipRect, color, 0, origin - DrawOffset, scale, SpriteEffects.None, 0);
        }
        ...
        public void Draw(Vector2 position, Vector2 origin, Color color, float scale, float rotation)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            RenderManager.SpriteBatch.Draw(Texture, position, ClipRect, color, rotation, origin - DrawOffset, scale, SpriteEffects.None, 0);
        }
        ...
        public void Draw(Vector2 position, Vector2 origin, Color color, float scale, float rotation, SpriteEffects flip)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            RenderManager.SpriteBatch.Draw(Texture, position, ClipRect, color, rotation, origin - DrawOffset, scale, flip, 0);
        }
        ...
        public void Draw(Vector2 position, Vector2 origin, Color color, Vector2 scale, float rotation, Rectangle clip)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            RenderManager.SpriteBatch.Draw(Texture, position, GetRelativeRect(clip), color, rotation, origin - DrawOffset, scale, SpriteEffects.None, 0);
        }
        ...
        public void DrawCentered(Vector2 position)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            RenderManager.SpriteBatch.Draw(Texture, position, ClipRect, Color.White, 0, Center - DrawOffset, 1f, SpriteEffects.None, 0);
        }
        ...
        public void DrawCentered(Vector2 position, Color color)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            RenderManager.SpriteBatch.Draw(Texture, position, ClipRect, color, 0, Center - DrawOffset, 1f, SpriteEffects.None, 0);
        }
        ...
        public void DrawCentered(Vector2 position, Color color, float scale)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            RenderManager.SpriteBatch.Draw(Texture, position, ClipRect, color, 0, Center - DrawOffset, scale, SpriteEffects.None, 0);
        }
        ...
        public void DrawCentered(Vector2 position, Color color, float scale, float rotation)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            RenderManager.SpriteBatch.Draw(Texture, position, ClipRect, color, rotation, Center - DrawOffset, scale, SpriteEffects.None, 0);
        }
        ...
        public void DrawCentered(Vector2 position, Color color, float scale, float rotation, SpriteEffects flip)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            RenderManager.SpriteBatch.Draw(Texture, position, ClipRect, color, rotation, Center - DrawOffset, scale, flip, 0);
        }
        ...
        public void DrawJustified(Vector2 position, Vector2 justify)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            RenderManager.SpriteBatch.Draw(Texture, position, ClipRect, Color.White, 0, new Vector2(Width * justify.X, Height * justify.Y) - DrawOffset, 1f, SpriteEffects.None, 0);
        }
        ...
        public void DrawJustified(Vector2 position, Vector2 justify, Color color)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            RenderManager.SpriteBatch.Draw(Texture, position, ClipRect, color, 0, new Vector2(Width * justify.X, Height * justify.Y) - DrawOffset, 1f, SpriteEffects.None, 0);
        }
        ...
        public void DrawJustified(Vector2 position, Vector2 justify, Color color, float scale)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            RenderManager.SpriteBatch.Draw(Texture, position, ClipRect, color, 0, new Vector2(Width * justify.X, Height * justify.Y) - DrawOffset, scale, SpriteEffects.None, 0);
        }
        ...
        public void DrawJustified(Vector2 position, Vector2 justify, Color color, float scale, float rotation)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            RenderManager.SpriteBatch.Draw(Texture, position, ClipRect, color, rotation, new Vector2(Width * justify.X, Height * justify.Y) - DrawOffset, scale, SpriteEffects.None, 0);
        }
        ...
        public void DrawJustified(Vector2 position, Vector2 justify, Color color, float scale, float rotation, SpriteEffects flip)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            RenderManager.SpriteBatch.Draw(Texture, position, ClipRect, color, rotation, new Vector2(Width * justify.X, Height * justify.Y) - DrawOffset, scale, flip, 0);
        }
        ...
        public void DrawOutline(Vector2 position)
        {
            ...
            for (var i = -1; i <= 1; i++)
                for (var j = -1; j <= 1; j++)
                    if (i != 0 || j != 0)
                        RenderManager.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, 0, -DrawOffset, 1f, SpriteEffects.None, 0);
        ...
        public void DrawOutline(Vector2 position, Vector2 origin)
        {
            ...
            for (var i = -1; i <= 1; i++)
                for (var j = -1; j <= 1; j++)
                    if (i != 0 || j != 0)
                        RenderManager.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, 0, origin - DrawOffset, 1f, SpriteEffects.None, 0);
        ...
        public void DrawOutline(Vector2 position, Vector2 origin, Color color, float scale)
        {
            ...
            for (var i = -1; i <= 1; i++)
                for (var j = -1; j <= 1; j++)
                    if (i != 0 || j != 0)
                        RenderManager.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, 0, origin - DrawOffset, scale, SpriteEffects.None, 0);
        ...
        public void DrawOutline(Vector2 position, Vector2 origin, Color color, float scale, float rotation)
        {
            ...
            for (var i = -1; i <= 1; i++)
                for (var j = -1; j <= 1; j++)
                    if (i != 0 || j != 0)
                        RenderManager.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, rotation, origin - DrawOffset, scale, SpriteEffects.None, 0);
        ...
        public void DrawOutline(Vector2 position, Vector2 origin, Color color, float scale, float rotation, SpriteEffects flip)
        {
            ...
            for (var i = -1; i <= 1; i++)
                for (var j = -1; j <= 1; j++)
                    if (i != 0 || j != 0)
                        RenderManager.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, rotation, origin - DrawOffset, scale, flip, 0);
        ...
        public void DrawOutlineCentered(Vector2 position)
        {
            ...
            for (var i = -1; i <= 1; i++)
                for (var j = -1; j <= 1; j++)
                    if (i != 0 || j != 0)
                        RenderManager.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, 0, Center - DrawOffset, 1f, SpriteEffects.None, 0);
        ...
        public void DrawOutlineCentered(Vector2 position, Color color, float scale)
        {
            ...
            for (var i = -1; i <= 1; i++)
                for (var j = -1; j <= 1; j++)
                    if (i != 0 || j != 0)
                        RenderManager.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, 0, Center - DrawOffset, scale, SpriteEffects.None, 0);
        ...
        public void DrawOutlineCentered(Vector2 position, Color color, float scale, float rotation)
        {
            ...
            for (var i = -1; i <= 1; i++)
                for (var j = -1; j <= 1; j++)
                    if (i != 0 || j != 0)
                        RenderManager.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, rotation, Center - DrawOffset, scale, SpriteEffects.None, 0);
        ...
        public void DrawOutlineCentered(Vector2 position, Color color, float scale, float rotation, SpriteEffects flip)
        {
            ...
            for (var i = -1; i <= 1; i++)
                for (var j = -1; j <= 1; j++)
                    if (i != 0 || j != 0)
                        RenderManager.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, rotation, Center - DrawOffset, scale, flip, 0);
        ...
        public void DrawOutlineJustified(Vector2 position, Vector2 justify)
        {
            ...
            for (var i = -1; i <= 1; i++)
                for (var j = -1; j <= 1; j++)
                    if (i != 0 || j != 0)
                        RenderManager.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, 0, new Vector2(Width * justify.X, Height * justify.Y) - DrawOffset, 1f, SpriteEffects.None, 0);
        ...
        public void DrawOutlineJustified(Vector2 position, Vector2 justify, Color color, float scale)
        {
            ...
            for (var i = -1; i <= 1; i++)
                for (var j = -1; j <= 1; j++)
                    if (i != 0 || j != 0)
                        RenderManager.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, 0, new Vector2(Width * justify.X, Height * justify.Y) - DrawOffset, scale, SpriteEffects.None, 0);
        ...
        public void DrawOutlineJustified(Vector2 position, Vector2 justify, Color color, float scale, float rotation)
        {
            ...
            for (var i = -1; i <= 1; i++)
                for (var j = -1; j <= 1; j++)
                    if (i != 0 || j != 0)
                        RenderManager.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, rotation, new Vector2(Width * justify.X, Height * justify.Y) - DrawOffset, scale, SpriteEffects.None, 0);
        ...
        public void DrawOutlineJustified(Vector2 position, Vector2 justify, Color color, float scale, float rotation, SpriteEffects flip)
        {
            ...
            for (var i = -1; i <= 1; i++)
                for (var j = -1; j <= 1; j++)
                    if (i != 0 || j != 0)
                        RenderManager.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, rotation, new Vector2(Width * justify.X, Height * justify.Y) - DrawOffset, scale, flip, 0);
