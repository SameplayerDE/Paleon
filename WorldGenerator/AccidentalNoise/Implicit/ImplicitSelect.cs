    ...
    public sealed class ImplicitSelect : ImplicitModuleBase
    {
        ...
        public override Double Get(Double x, Double y)
        {
            ...
            if (falloff > 0.0)
            {
                ...
                var blend = MyMathHelper.QuinticBlend((value - lower) / (upper - lower));
				return MyMathHelper.Lerp(blend, this.Low.Get(x, y), this.High.Get(x, y));
            }
        ...
        public override Double Get(Double x, Double y, Double z)
        {
            ...
            if (falloff > 0.0)
            {
                ...
                var upper = threshold + falloff;
				var blend = MyMathHelper.QuinticBlend((value - lower) / (upper - lower));
				return MyMathHelper.Lerp(blend, this.Low.Get(x, y, z), this.High.Get(x, y, z));
            }
        ...
        public override Double Get(Double x, Double y, Double z, Double w)
        {
            ...
            if (falloff > 0.0)
            {
                ...
                var upper = threshold + falloff;
				var blend = MyMathHelper.QuinticBlend((value - lower) / (upper - lower));
				return MyMathHelper.Lerp(blend, this.Low.Get(x, y, z, w), this.High.Get(x, y, z, w));
            }
        ...
        public override Double Get(Double x, Double y, Double z, Double w, Double u, Double v)
        {
            ...
            if (falloff > 0.0)
            {
                ...
                var upper = threshold + falloff;
				var blend = MyMathHelper.QuinticBlend((value - lower) / (upper - lower));
				return MyMathHelper.Lerp(blend, this.Low.Get(x, y, z, w, u, v), this.High.Get(x, y, z, w, u, v));
            }
